...
export const generateOrderPDF = (order, user) => {
    ...
    doc.text(`Pedido N°: ${order.id}`, 20, 60);  // Id del pedido
    doc.text(`N° Cliente: ${user.userNumber}`, 20, 70);  // Número del cliente
    doc.text(`Cliente: ${user.name}`, 20, 80);  // Nombre del cliente
